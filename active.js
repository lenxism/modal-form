window.cfields = { "7": "empresa", "115": "n_de_funcionrios", "4": "cargo", "143": "mais_informaes" };
    ...
    (function () {
        ...
        var form_submit = function (e) {
            ...
            if (validate_form()) {
                ...
                var serialized = form_serialize(document.getElementById('_form_3')).replace(/%0A/g, '\\n');
                var err = form_to_submit.querySelector('._form_error');
                err ? err.parentNode.removeChild(err) : false;
                _load_script('https://eventplay.activehosted.com/proc.php?' + serialized + '&jsonp=true');
            }
            return false;
        };
